...
const InDevelopmentTag = () => (
  <div className="inline-flex items-center gap-1.5 rounded-full bg-amber-500/15 px-2.5 py-0.5 text-[10px] font-medium uppercase tracking-wider text-amber-400">
  ...
  return (
    ...
    <div className="container-narrow">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 md:gap-5">
        {/* Featured: AI CV Intelligence — spans 2 cols, 2 rows on desktop — LIVE */}
        ...
        {/* Dynamic Crew Complement Scales — IN DEVELOPMENT */}
        <div className={tile}>
          <RevealOnScroll direction="up" delay={0.2}>
            ...
            <ul className="mt-2 space-y-1 text-xs text-muted-foreground list-none sm:text-sm">
              <li className="flex gap-2"><div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary/60" />Designed for real-time monitoring of safe complement requirements across the fleet.</li>
              <li className="flex gap-2"><div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary/60" /><span className="min-w-0"><span className="text-foreground">Fleet-wide STCW &amp; medical</span> visibility, beyond document-by-document checks.</span></li>
            </ul>
        ...
        {/* Full-Spectrum Fleet Readiness — IN DEVELOPMENT */}
        <div className={tile}>
          <RevealOnScroll direction="up" delay={0.3}>
            ...
            <ul className="mt-2 space-y-1 text-xs text-muted-foreground list-none sm:text-sm">
              <li className="flex gap-2"><div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary/60" />Built to serve the entire maritime industry — adaptive across every vessel class.</li>
              <li className="flex gap-2"><div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary/60" /><span className="min-w-0"><span className="text-foreground">Full-spectrum compliance</span> — STCW today, with ISM and specialised certifications on the roadmap.</span></li>
            </ul>
            <div className="mt-4 grid grid-cols-2 gap-2">
              {["ALL VESSEL CLASSES", "ALL FLEET SIZES", "ALL TRADE ROUTES", "ALL FLAG STATES"].map((v) => (
      ...
      {/* STCW Expiry Radar — full-width bottom tile — LIVE */}
      <div className={tile}>
